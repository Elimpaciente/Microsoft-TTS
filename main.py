    ...
    if not voice_exists:
        return JSONResponse(
            content={
                "status_code": 404,
                "developer": DEVELOPER,
                "message": f"Voz '{voice}' no encontrada. Usa /voices para ver las disponibles"
            },
            status_code=404
        )
    ...
    try:
        ...
        return JSONResponse(
            content={
                "status_code": 504,
                "developer": DEVELOPER,
                "message": "Timeout: El servicio TTS tardó demasiado"
            },
            status_code=504
        )
